...
$header .= "From: Новая заявка <alekkss1993@yandex.ru>\n\n";	
$mail = mail("alekkss1993@yandex.ru", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
